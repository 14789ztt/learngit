...
Yellow_threshold = (60, 74, -14, 4, 0, 17)#  寻色块用 黄色
...
def Isblob():
    ...
    red_blobs = img.find_blobs([Red_threshold_threshold], pixels_threshold=3, area_threshold=10, merge=True, margin=5)#识别红色物体,area_threshold = 3
    if red_blobs:
        Dot.blob_state = 1
    else:
        Dot.blob_state = 0
